        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex items-center justify-between gap-4 border-b border-white/5 pb-4 mb-4">
                ...
                <button
                    ...
                    className="bg-purple-500/20 text-purple-400 border border-purple-500/30 px-3.5 py-1.5 rounded-full text-xs font-bold hover:bg-purple-500/30 active:scale-[0.98] transition-all flex items-center gap-1.5 whitespace-nowrap"
                >
                    <Plus className="w-3.5 h-3.5" /> GENERATE NEW CARD
                </button>
            </div>
