-- MINIMAL User Management Functions
-- Only uses columns that actually exist in profiles table
...
-- ============================================
-- Function: create_dashboard_user (MINIMAL)
-- ============================================
...
-- Create profile (ONLY user_id, full_name, role, staff_id - minimal columns)
